...
function LibraryAdmin() {
  ...
  return (
    <>
      <Button onClick={e=>window.location.href='/formateurValid'}> Formateurs en demande </Button>
      <Container>
        ...
        <Row xs={1} md={2}>
          ...
          <Card style={{ width: "100%" }} onClick={e=>window.location.href='/creation'}>
                <Card.Body>
                  <Card.Title>Ajouter formation</Card.Title>
                </Card.Body>
              </Card>
        </Row>
      </Container>
